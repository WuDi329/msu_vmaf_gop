#!/bin/bash
# 此模块的功能是根据GOP的范围将源视频和重新编码视频的前三帧生成视频段。
# NOTE : Quote it else use array to avoid problems #
ref_path=/dataset/dataset/reference_videos/
dis_path=/dataset/dataset/reference_videos/output_16000k/
files=$(ls $ref_path | grep '\.mp4$')
# output_path=/data/wd/dataset/dataset/reference_videos/new_output/
output_path=/dataset/dataset/reference_videos/output_16000k/gops/

gop_path=/home/wudi/desktop/dataset_operation/I-numbers-all/
